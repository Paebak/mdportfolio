      ...
      <div className='max-w-{1000px} mx-auto px-8 flex flex-col justify-center h-full'>
        ...
        <p className='text-[#8892b0] font-semibold py-4 max-w-[700px] pl-4'>
         I specialize in building, securing, and occasionally designing, exceptional
          digital experiences. Currently, I'm focused on building responsive full-stack web applications just like
          this one.
        </p>
        <div className='pl-4'>
          <button  className= ' text-white rounded-md group border-2 px-6 py-3  my-2 flex items-center hover:bg-orange-300 hover:border-orange-300 hover:duration-300'>
            View Work 
