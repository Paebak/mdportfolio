      ...
      <div className="hidden md:flex fixed flex-col top-[35%] left-0">
        <ul>
          <li className="w-[160px] h-[60px] flex justify-between items center ml-[-100px] hover:ml-[-10px] duration-300">
            <a
              className="flex rounded-md justify-between items-center w-full text-gray-200 bg-blue-600 pl-4 pr-2"
          ...
          <li className="w-[160px] h-[60px] flex justify-between items center ml-[-100px] hover:ml-[-10px] duration-300">
            <a
              className="flex rounded-md justify-between items-center w-full text-gray-200 bg-gray-900 pl-4 pr-2"
          ...
          <li className="w-[160px] h-[60px] flex justify-between items center ml-[-100px] hover:ml-[-10px] duration-300">
            <a
              className="flex rounded-md justify-between items-center w-full text-gray-200 bg-green-500 pl-4 pr-2"
          ...
          <li className="w-[160px] h-[60px] flex justify-between items center ml-[-100px] hover:ml-[-10px] duration-300">
            <a
              className="flex rounded-md justify-between items-center w-full text-gray-200 bg-red-500 pl-4 pr-2"
              href="/"
              target="_blank">
